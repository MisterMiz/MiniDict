...
class PlayPageTH2EN extends StatefulWidget {
  @override
  _PlayPageTH2ENState createState() => _PlayPageTH2ENState();
}

class _PlayPageTH2ENState extends State<PlayPageTH2EN> {
  ...
  void countDown() {
    ctime = Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      if (time <= 0) {
        txtScore = 'Time Out!';
        timer.cancel();
        Navigator.pushReplacementNamed(context, '/resultscore',
            arguments: score);
        // buttonStatus = 'Start';
      }
    });
